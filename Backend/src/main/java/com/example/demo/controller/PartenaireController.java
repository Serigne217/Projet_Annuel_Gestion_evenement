...
public class PartenaireController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> updatePartner(@PathVariable Integer id, @RequestBody Partenaire partenaireDetails) {
        ...
        partenaire.setType_activite(partenaireDetails.getType_activite());
